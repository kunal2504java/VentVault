        ...
        <div className="min-h-screen transition-all duration-700 bg-gradient-to-br from-black via-neutral-900/80 to-amber-950/20">
            ...
            <div className="relative z-10 min-h-screen">
                ...
                <header className="pt-24 pb-20 px-6 text-center max-w-3xl mx-auto">
                    <h1
                        className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-sentient italic font-light mb-8 transition-colors duration-700"
                        style={{ color: "#FFC700" }}
                    >
                        A place to put things down
                    </h1>
                    <p className="text-lg md:text-xl font-sentient leading-relaxed transition-colors duration-700 text-neutral-400">
                ...
                <main className="px-6 pb-24 max-w-2xl mx-auto">
                    ...
                    <section className="mb-20">
                        <h2 className="text-sm font-mono mb-6 transition-colors duration-700 text-neutral-500">
                            Why this exists
                        </h2>
                        <div className="space-y-6 font-sentient text-lg leading-relaxed transition-colors duration-700 text-neutral-300">
                            <p>
                    ...
                    <section className="mb-20">
                        ...
                        <div className="space-y-4 font-sentient text-lg leading-relaxed transition-colors duration-700 text-neutral-300">
                    ...
                    {/* 5. Developer's Note */}
                    <section className="mb-20 p-8 rounded-2xl transition-all duration-500 bg-neutral-900/30 border border-neutral-800">
                        <h2 className="text-sm font-mono mb-6 transition-colors duration-700 text-amber-200/60">
                        ...
                        <div className="space-y-6 font-sentient text-lg leading-relaxed transition-colors duration-700 text-neutral-300">
                            ...
                            <p className="font-sentient italic text-neutral-300">
                    ...
                    <section className="text-center pt-8">
                        <h2 className="text-2xl md:text-3xl font-sentient italic font-light mb-6 transition-colors duration-700 text-white">
                            You're welcome here
                        </h2>
                        <p className="font-sentient text-lg leading-relaxed mb-10 transition-colors duration-700 text-neutral-400">
                        ...
                        <Link
                            href="/vent"
                            className="inline-block px-10 py-4 font-mono text-sm tracking-wider rounded-full border transition-all duration-300 border-neutral-700 text-neutral-300 hover:bg-neutral-800"
                        >
