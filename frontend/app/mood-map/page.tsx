      ...
      {template === "modern" ? (
        <div className="min-h-screen bg-[#050505] text-white flex justify-center px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-10">
          ...
          <div ref={contentRef} className="w-full max-w-[1200px] flex flex-col gap-6">
            <header className="flex items-center justify-between px-4 sm:px-6 py-6"></header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 auto-rows-auto gap-4 sm:gap-6">
              <div className="md:col-span-2 bg-black rounded-[32px] p-6 sm:p-8 relative overflow-hidden flex flex-col justify-end min-h-[380px] border border-[#262626] transition-all hover:border-[#404040] hover:-translate-y-0.5">
                ...
                <div className="relative z-10">
                  <div className="text-xl sm:text-2xl text-[#ccf381] mb-2 font-medium">Your Emotional Snapshot</div>
                  ...
                  <div className="mt-6 bg-white/10 backdrop-blur-md border-t border-white/20 p-4 sm:p-5 rounded-2xl">
                    <p className="text-sm sm:text-base font-medium opacity-90">
                      This is how your emotions unfolded — no judgment.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-b from-[#1a1a1a] to-[#121212] rounded-[32px] p-6 sm:p-8 flex flex-col justify-between min-h-[380px] border border-[#262626] transition-all hover:border-[#404040] hover:-translate-y-0.5">
                <div>
                  ...
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-bold leading-none mb-2 bg-gradient-to-br from-[#7928ca] to-[#ff0080] bg-clip-text text-transparent">
                    12 <span className="text-xs sm:text-sm text-[#a1a1aa] font-semibold">patterns</span>
                  </div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-bold leading-none mb-2 bg-gradient-to-br from-[#7928ca] to-[#ff0080] bg-clip-text text-transparent mt-3">
                    4 <span className="text-xs sm:text-sm text-[#a1a1aa] font-semibold">recurring themes</span>
                  </div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-bold leading-none bg-gradient-to-br from-[#7928ca] to-[#ff0080] bg-clip-text text-transparent mt-3">
                    3 <span className="text-xs sm:text-sm text-[#a1a1aa] font-semibold">strong emotions</span>
                  </div>
                </div>

                <div className="mt-8">
                  <div className="text-xs sm:text-sm text-[#a1a1aa] font-normal">Based on your check-ins.</div>
                </div>
              </div>
              ...
              <div className="bg-white text-black rounded-[32px] p-6 sm:p-8 flex flex-col justify-between min-h-[320px] sm:min-h-[380px] border border-[#262626] transition-all hover:border-[#404040] hover:-translate-y-0.5">
                ...
                <div className="text-sm leading-relaxed font-medium border-t border-black/10 pt-5">
                  You tend to process emotions internally and release them in focused moments.
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#ff6b6b] via-[#ffd93d] to-[#6bcf7f] rounded-[32px] p-6 sm:p-8 min-h-[320px] sm:min-h-[380px] relative overflow-hidden transition-all hover:-translate-y-1 flex flex-col justify-between">
                <img
                ...
                />
                <div className="relative z-10">
                  <div className="font-bold text-sm uppercase mb-1 text-black">Most Felt</div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-3xl sm:text-4xl font-bold text-black">
                    Emotion
                  </div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-bold text-black mt-8 mb-8">
                    Overwhelm
                  </div>
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex gap-3">
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-xs mt-1 text-black font-medium">Overthinking</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-full bg-[#3b82f6] border-2 border-black"></div>
                      <span className="text-xs mt-1 text-black font-medium">Calm</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-full bg-[#f97316] border-2 border-black"></div>
                      <span className="text-xs mt-1 text-black font-medium">Anxiety</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-full bg-[#22c55e] border-2 border-black"></div>
                      <span className="text-xs mt-1 text-black font-medium">Relief</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-2 lg:col-span-4 bg-gradient-to-r from-[#121212] to-[#1a1a1a] rounded-[32px] p-6 sm:p-8 lg:p-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 min-h-[200px] sm:min-h-[240px] border border-[#262626] transition-all hover:border-[#404040] hover:-translate-y-0.5">
                <div>
                  <h3 className="font-[family-name:var(--font-space-grotesk)] text-2xl sm:text-3xl font-bold mb-2">
                    Share Your Emotional Snapshot
                  </h3>
                  <p className="text-[#a1a1aa] text-sm sm:text-base">No content. Just patterns.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 auto-rows-auto gap-4 sm:gap-6">
              <div className="md:col-span-2 bg-white rounded-none p-6 sm:p-8 relative overflow-hidden flex flex-col justify-end min-h-[380px] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-6 bg-white border-4 border-black p-4 sm:p-5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    <p className="text-sm sm:text-base font-bold">This is how your emotions unfolded — no judgment.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-none p-6 sm:p-8 flex flex-col justify-between min-h-[380px] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                <div>
                  ...
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none mb-2 text-black">
                    12 <span className="text-xs sm:text-sm text-black/60 font-black">patterns</span>
                  </div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none mb-2 text-black mt-3">
                    4 <span className="text-xs sm:text-sm text-black/60 font-black">recurring themes</span>
                  </div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none text-black mt-3">
                    3 <span className="text-xs sm:text-sm text-black/60 font-black">strong emotions</span>
                  </div>
                </div>

                <div className="mt-8">
                  <div className="text-xs sm:text-sm font-normal">Based on your check-ins.</div>
                </div>
              </div>
              ...
              <div className="bg-[#ffd60a] rounded-none p-6 sm:p-8 min-h-[320px] sm:min-h-[380px] border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                <div
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none mt-8 mb-8">
                      Overwhelm
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 border-4 border-black bg-[#7928ca]"></div>
                        <span className="text-xs mt-1 font-bold">Overthinking</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 border-4 border-black bg-[#3b82f6]"></div>
                        <span className="text-xs mt-1 font-bold">Calm</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 border-4 border-black bg-[#f97316]"></div>
                        <span className="text-xs mt-1 font-bold">Anxiety</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 border-4 border-black bg-[#22c55e]"></div>
                        <span className="text-xs mt-1 font-bold">Relief</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="md:col-span-2 lg:col-span-2 bg-white rounded-none p-6 sm:p-8 min-h-[320px] sm:min-h-[380px] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              ...
              <div className="md:col-span-2 lg:col-span-4 bg-white rounded-none p-6 sm:p-8 lg:p-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 min-h-[200px] sm:min-h-[240px] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                <div>
                  ...
                  <p className="text-black font-bold text-sm sm:text-base">No content. Just patterns.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 auto-rows-auto gap-4 sm:gap-6">
              <div className="md:col-span-2 bg-gradient-to-br from-[#667eea] via-[#764ba2] to-[#f093fb] rounded-[32px] p-6 sm:p-10 relative overflow-hidden flex flex-col justify-between min-h-[380px] border-2 border-white/30 shadow-2xl transition-all hover:scale-[1.02]">
                ...
                <div className="relative z-10 flex flex-col justify-end h-full">
                  <div className="inline-flex items-center gap-2 text-lg sm:text-xl font-black mb-6 bg-white/20 backdrop-blur-md px-5 py-3 rounded-full border border-white/40 self-start shadow-lg">
                    ...
                    <span>Your Emotional Snapshot</span>
                  </div>
              ...
              <div className="bg-gradient-to-br from-[#fa709a] to-[#fee140] text-black rounded-[32px] p-6 sm:p-8 flex flex-col justify-between min-h-[380px] border-2 border-white/50 shadow-2xl transition-all hover:scale-[1.02]">
                <div>
                  ...
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none mb-2 [text-shadow:_3px_3px_0_rgb(255_255_255_/_50%)]">
                    12 <span className="text-xs sm:text-sm font-black opacity-80">patterns</span>
                  </div>
                  <div className="text-xs sm:text-sm font-black mt-3 opacity-80">4 recurring themes</div>
                  <div className="text-xs sm:text-sm font-black mt-2 opacity-80">3 strong emotions</div>
                </div>

                <div className="mt-8">
                  <div className="text-xs sm:text-sm font-normal opacity-80">Based on your check-ins.</div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 auto-rows-auto gap-4 sm:gap-6">
              ...
              <div className="bg-[#00ff00] text-black border-8 border-black p-6 sm:p-8 flex flex-col justify-between min-h-[380px] shadow-[12px_12px_0px_0px_#000] transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-[8px_8px_0px_0px_#000]">
                <div>
                  ...
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none mb-2 text-white [text-shadow:_4px_4px_0_#ff00ff]">
                    12 <span className="text-xs sm:text-sm text-white/60 font-black">patterns</span>
                  </div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none mb-2 text-white [text-shadow:_4px_4px_0_#ff00ff] mt-3">
                    4 <span className="text-xs sm:text-sm text-white/60 font-black">recurring themes</span>
                  </div>
                  <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none text-white [text-shadow:_4px_4px_0_#ff00ff] mt-3">
                    3 <span className="text-xs sm:text-sm text-white/60 font-black">strong emotions</span>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-[#ff6b6b] via-[#ffd93d] to-[#6bcf7f] border-8 border-black p-6 sm:p-8 min-h-[320px] sm:min-h-[380px] shadow-[16px_16px_0px_0px_#000] relative overflow-hidden transition-all hover:translate-x-2 hover:translate-y-2 hover:shadow-[8px_8px_0px_0px_#000] flex flex-col">
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#ff00ff] opacity-30 translate-x-12 -translate-y-12"></div>
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <div className="font-[family-name:var(--font-space-grotesk)] text-5xl sm:text-6xl font-black leading-none mt-8 mb-8 [text-shadow:_5px_5px_0_#ff00ff]">
                      Overwhelm
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-[#7928ca] border-4 border-black shadow-[4px_4px_0px_0px_#000]"></div>
                        <span className="text-xs mt-1 font-black">Overthinking</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-[#3b82f6] border-4 border-black shadow-[4px_4px_0px_0px_#000]"></div>
                        <span className="text-xs mt-1 font-black">Calm</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-[#f97316] border-4 border-black shadow-[4px_4px_0px_0px_#000]"></div>
                        <span className="text-xs mt-1 font-black">Anxiety</span>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-[#22c55e] border-4 border-black shadow-[4px_4px_0px_0px_#000]"></div>
                        <span className="text-xs mt-1 font-black">Relief</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="md:col-span-2 lg:col-span-4 bg-gradient-to-r from-[#ff00ff] via-[#00ff00] to-[#ffff00] border-8 border-black p-6 sm:p-8 lg:p-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 min-h-[200px] sm:min-h-[240px] shadow-[12px_12px_0px_0px_#000] transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-[8px_8px_0px_0px_#000]">
                <div>
                  ...
                  <p className="text-white text-sm sm:text-base font-black">No content. Just patterns.</p>
                </div>
