    ...
    <>
      <div className="fixed z-50 pt-6 md:pt-10 top-0 left-0 w-full">
        <header className="flex items-center justify-between container">
          <Link href="/" className="-ml-6 md:-ml-8">
          ...
          <Dialog.Root modal={false} open={isOpen} onOpenChange={setIsOpen}>
            <Dialog.Trigger asChild>
              <button
                className="group max-lg:hidden p-2 text-foreground transition-colors"
              ...
              >
                ...
                <nav className="flex flex-col space-y-4 container mx-auto">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-base font-mono uppercase text-foreground/60 transition-colors ease-out duration-150 hover:text-foreground/100 py-1"
                  >
                    ...
                    <SignedOut>
                      <div className="flex flex-col space-y-3">
                        <SignInButton mode="modal">
                          <button className="text-lg font-mono uppercase transition-colors ease-out duration-150 hover:text-foreground/80 py-1 text-left" style={{ color: "#FFC700" }}>
                            Sign In
                          </button>
                        </SignInButton>
                        <SignUpButton mode="modal">
                          <button className="text-base font-mono uppercase text-foreground/60 transition-colors ease-out duration-150 hover:text-foreground/100 py-1 text-left">
                            Create Account
                          </button>
                        </SignUpButton>
                      </div>
          ...
          <MobileMenu className="mr-6 md:mr-8" />
        </header>
      </div>
